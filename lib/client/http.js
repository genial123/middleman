...
HTTPClient.prototype.json = function(url, fields, ignoreErrors, callback) {
	...
	switch (params['type']) {
		case 'json':
			request(options, function(err, resp, body) {
				...
				if (!params.ignoreErrors && ((resp.statusCode < 200) || (resp.statusCode > 300))) return callback('Received HTTP code '+resp.statusCode+' - '+options.url);
