...
CPHttp.prototype.reScanMovie = function(cpid, ptpid, callback) {
	var self = this;
	...
	self.searcher.advanced(5, [0, 270, 0], [
		function(opts) {
			...
			self.movieReleasesIds(cpid, function(err, releaseIds) {
				...
				if (help.inArray(ptpid, releaseIds))
			...
			if ((typeof opts.success !== 'undefined') && opts.success) {
				self.logger.info('CouchPotato has discovered torrent #'+ptpid+', assuming everything went OK');
				return opts.cb(null);
			}
