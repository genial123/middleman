...
function Bot(config) {
	...
	this.config = config;
	this.client = new irc.Client(config.server, config.port, config.secure, config.iicert, config.debug);
...
Bot.prototype.forceNick = function() {
	return this.Plugins.Nick.forceNick();
};
